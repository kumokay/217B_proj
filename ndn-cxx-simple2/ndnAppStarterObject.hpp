...
#ifndef NDN_APP_STARTER_OBJECT_HPP
#define NDN_APP_STARTER_OBJECT_HPP

#include "ndnAppStarter.hpp"
#include "ndnObjectApp.hpp"
...
#define CLASSNAME ndnAppStarterObject
#define APPNAME app::ndnObjectApp
...
protected:
  ...
  StartApplication()
  {
    ...
    m_instance->stat_logging_start("mylog/object.txt");
    m_instance->run();
  }
